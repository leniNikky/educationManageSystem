                ...
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li class="left-nav-item2"><a href="#">修改课程</a></li>
                                    <li class="left-nav-item2"><a href="#">删除课程</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="sidebar-dropdown">
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li class="left-nav-item4"><a href="#">入职办理</a></li>
                                    <li class="left-nav-item4"><a href="#">工资单</a></li>
                                    <li class="left-nav-item4"><a href="#">离职办理</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="header-menu"><span>个人操作</span></li>
                        <li class="left-nav-item5"><a href="#"><i class="fa fa-tv"></i><span>修改个人信息</span></a></li>                   
                        <li class="left-nav-item6"><a href="#"><i class="fa fa-photo"></i><span>修改密码</span></a></li>
                    </ul>
                   </div><!-- sidebar-menu  -->            
                </div><!-- sidebar-content  -->
